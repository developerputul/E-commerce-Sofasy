                ...
                $.each(response.carts, function(key,value){
                    miniCart += `<ul>
                                <li>
                                    ...
                                    <div class="shopping-cart-delete" style="margin: 85 1px 0px;">
            ...
            success:function(response){
                ...
                $.each(response, function(key,value){
                    ...
                    rows += `<tr class="pr_image">
                                ...
                                <td class="row_img"><img src="/${value.product.product_thambnail}" style="width:300px; height:300px;"
                                 alt="compare-img" /></td>
                            ...
                            <tr class="pr_remove text-muted">
                                ...
                                <td class="row_remove">
                                    ...
                                    <i class="fi-rs-trash mr-5"></i><span>Remove</span> </a>
                                </td>
                            </tr>`
            ...
            success:function(data){
                ...
                if (data.total) {
                    ...
                    <tr>
                        ...
                        <td class="cart_total_amount">
                            <h5 class="text-brand text-end">${data.coupon_name} 
                            <a type="submit" onclick="couponRemove()"><i class="fi-rs-trash"></i></a></h5>
                        </td>
                    </tr>
